...
import { JanelaResultado } from "@/components/calculadoras/janela-resultado";
import type { ResultadoJanela } from "@/lib/calc/janela";
import { formatDateTime } from "@/lib/utils";

export default async function CalculoJanelaDetalhePage({
  params,
}: {
  ...
  const resultado = calculo.resultado as unknown as ResultadoJanela;
