...
export function SacadaLResultado({ resultado }: { resultado: ResultadoSacadaL }) {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-border bg-surface p-6">
        ...
        <SacadaLDesenho resultado={resultado} />
      </div>
      ...
      <div className="rounded-2xl border border-border bg-surface p-6">
        ...
        <p className="mt-3 text-xs text-muted">
          Abertura no {resultado.abertura.segmentoId === "A" ? "Lado A" : "Lado B"}, lado {resultado.abertura.lado}.
        </p>
      </div>
