...
export function SacadaResultado({ resultado }: { resultado: ResultadoSacadaReta }) {
          ...
          <tbody>
            {resultado.paineis.map((p) => (
              <tr key={p.identificacao} className="border-b border-border last:border-0">
                ...
                <td className="py-2 text-muted">{p.posicaoUsinagemMm} mm</td>
