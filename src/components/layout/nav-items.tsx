export const NAV_ITEMS = [
  { href: "/dashboard", label: "Dashboard", icon: "grid", grupo: "Principal" },
  { href: "/clientes", label: "Clientes", icon: "users", grupo: "Principal" },
  { href: "/obras", label: "Obras", icon: "obra", grupo: "Principal" },
  { href: "/orcamentos", label: "Orçamentos", icon: "orcamento", grupo: "Principal" },
  { href: "/calculadoras", label: "Calculadoras", icon: "calculadora", grupo: "Principal" },
  { href: "/configurador-visual", label: "Configurador Visual", icon: "visual", grupo: "Principal" },

  { href: "/producao", label: "Produção", icon: "producao", grupo: "Produção" },
  { href: "/pedidos-tempera", label: "Pedidos de Têmpera", icon: "tempera", grupo: "Produção" },
  { href: "/plano-corte-vidro", label: "Plano de Corte de Vidro", icon: "corte", grupo: "Produção" },
  { href: "/plano-corte-perfis", label: "Plano de Corte de Perfis", icon: "corte", grupo: "Produção" },
  { href: "/beneficiamentos", label: "Beneficiamentos", icon: "beneficiamento", grupo: "Produção" },
  { href: "/esquadrias-serralheria", label: "Esquadrias e Serralheria", icon: "esquadria", grupo: "Produção" },
  { href: "/agenda", label: "Agenda e Instalações", icon: "agenda", grupo: "Produção" },
  { href: "/garantia", label: "Garantia e Pós-venda", icon: "garantia", grupo: "Produção" },
  ...
  { href: "/relatorios", label: "Relatórios", icon: "grafico", grupo: "Gestão" },
  { href: "/auditoria", label: "Auditoria", icon: "shield", grupo: "Gestão" },

  { href: "/usuarios", label: "Usuários", icon: "user-cog", grupo: "Empresa" },
  { href: "/empresa", label: "Empresa", icon: "building", grupo: "Empresa" },
  { href: "/planos", label: "Planos e Assinatura", icon: "estrela", grupo: "Empresa" },
  { href: "/progresso", label: "Progresso dos Módulos", icon: "list-check", grupo: "Empresa" },
] as const;
